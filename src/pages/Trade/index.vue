  ...
  <div class="trade-container">
    ...
    <div class="money clearFix">
      <ul>
        ...
        <li>
          <b>返现：</b>
          <span>{{ tradeInfo.activityReduceAmount }}.00</span>
        </li>
        <li>
          <b>运费：</b>
          <span>0.00</span>
    ...
    <div class="sub clearFix">
      <a href="#" class="subBtn" @click="submitTrade">提交订单</a>
    </div>
  </div>
</template>
...
export default {
  ...
  computed: {
    ...mapState("tradeOptions", ["tradeInfo", "userAddressList"]),
    defaultAddress() {
      return this.userAddressList.find((item) => item.isDefault == "1") || {};
    },
  },
  methods: {
    ...mapActions("tradeOptions", ["getTradeInfo", "getUserAddressList"]),
    changeDefault(userAddress) {
      for (let index in this.userAddressList) {
        this.userAddressList[index].isDefault = "0";
      }
    ...
    submitTrade(event) {
      ...
      this.$api.reqSumbitTrade({tradeNo,data}).then((response) => {

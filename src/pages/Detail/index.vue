      ...
      <div class="mainCon">
        ...
        <div class="InfoWrap">
          ...
          <div class="choose">
            ...
            <div class="cartWrap">
              <div class="controls">
                <input autocomplete="off" class="itxt" v-model="goodValue" @change="hander(goodValue)"/>
                <a href="javascript:" class="plus" @click="goodValue++">+</a>
                <a href="javascript:" class="mins" @click="goodValue < 2? 1:goodValue--">-</a>
              </div>
              <div class="add">
                <a href="javascript:" @click="addShopcar($route.params.skuId,goodValue)">加入购物车</a>
              </div>
            </div>
          </div>
        </div>
...
export default {
  ...
  methods: {
    ...mapActions("detailOptions", ["getDetailInfo","addShopcarNum"]),
    changeChecked(index,arrs){
      for(let arr in arrs){
        arrs[arr].isChecked = "0"
      }
      arrs[index].isChecked = "1" 
    },
    hander(value){
      ...
      if(isNaN(inputValue) || inputValue < 1){
        ...
        this.goodValue = parseInt(value)
      }
    },
    addShopcar(skuId,skuNum){
      this.addShopcarNum({skuId,skuNum}).then((response) => {
